...
export function CloseConcerts() {
  return (
    <section className="w-full max-w-7xl mx-auto px-10 py-16">
      ...
      <div className="grid grid-cols-1 grid-rows-3 lg:grid-cols-3 lg:grid-rows-2 gap-8">
        {/* main image */}
        <div className="cursor-pointer relative aspect-video lg:aspect-auto overflow-hidden lg:col-span-2 lg:row-span-full">
